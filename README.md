...
- I am currently working with Pacificorp's Energy Supply Management team where I am exploring applications of Reinforcement Learning and Stochastic Processes to optimize bidding and dispatch strategies for Thermal and Variable Energy Resources. I also work on setting up a scalable data infrastructure for consolidating 10+ heterogeneous telemetry and time series data sources at TB scale into a centralized datalake on Azure databricks.
